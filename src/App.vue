...
<template>
  <main class="relative">
    <div class="bg-gray-200 rounded-bl-[5.5rem] rounded-br-[5.5rem]">
      <div class="p-12 grid grid-cols-2">
        <div>
          <h1 class="font-medium text-xs">aurelio.theodhore@gmail.com</h1>
        </div>
        <div>
          <ul class="flex float-end">
            <li class="mr-2 font-semibold text-xs">About Me</li>
            <li class="mr-2 font-semibold text-xs">/</li>
            <li class="mr-2 font-semibold text-xs">Projects</li>
            <li class="mr-2 font-semibold text-xs">/</li>
            <li class="mr-2 font-semibold text-xs">FaQs</li>
          </ul>
        </div>
      </div>
      <div class="p-14 px-13 pt-0 grid grid-cols-2">
        <div>
          ...
          <h1 class="w-[80%] font-normal mt-6 mb-6">
    ...
    <div>
      <h1 class="text-center font-semibold my-10">My Toolbox: Technoliges I Work With</h1>
      <div class="techImage flex items-center justify-center">
        <img class="mx-10 mb-14" src="./assets/img/image 1.png" width="60" alt="" />
        <img class="mx-10 mb-14" src="./assets/img/image 2.png" width="69" alt="" />
        <img class="mx-10 mb-14" src="./assets/img/image 3.png" width="88" alt="" />
        <img class="mx-10 mb-14" src="./assets/img/image 4.png" width="66" alt="" />
        <img class="mx-10 mb-14" src="./assets/img/image 5.png" width="94" alt="" />
        <img class="mx-10 mb-14" src="./assets/img/image 6.png" width="72" alt="" />
      </div>
    </div>
